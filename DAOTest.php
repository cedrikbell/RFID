<?php
require_once "C:\wamp\bin\php\php5.5.12\IArticleDAO.php";
require_once "C:\wamp\bin\php\php5.5.12\ArticleDAO.php";
/*
...
class ArticleDAOTest extends PHPUnit_Extensions_Database_TestCase
{
    public function getConnection() {
        $db = new PDO(
            "mysql:host=localhost;dbname=UnitTest", 
            "root", "sqldba");
        return $this->createDefaultDBConnection($db, "UnitTest");
    }
    /*
